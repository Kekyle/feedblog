...
import by.microfeedblog.feedblog.service.PostService;
...
public class PostResource {
    ...
    @PostMapping
    public ResponseEntity<Post> save(@Valid @RequestBody PostDto post){
    ...
    @PutMapping
    public ResponseEntity<Post> update(@Valid @RequestBody PostDto post){
